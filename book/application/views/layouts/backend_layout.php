...
<head>
    ...
    <title><?= vars('page_title') ?? lang('backend_section') ?> | thesibook.gr</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?= asset_url('assets/vendor/flatpickr/material_blue.min.css') ?>">
