...
$lang['about_app'] = 'About thesibook.gr';
...
$lang['about_app_info'] = 'thesibook.gr is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using thesibook.gr you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'thesibook.gr is licensed under the GPLv3 license. By using the code of thesibook.gr in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'thesibook.gr has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the thesibook.gr API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the thesibook.gr data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into thesibook.gr and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
...
$lang['class_oriented_booking'] = 'Class-Oriented Booking Mode';
$lang['class_oriented_booking_hint'] = 'Show a weekly lesson calendar on the public booking page instead of the service and provider wizard. Each lesson is a Service linked to one provider (teacher) with a fixed time slot.';
$lang['class_schedule_title'] = 'Weekly Schedule';
$lang['class_weekly_hint'] = 'Click an available lesson to book your place. Full classes are shown in grey.';
$lang['class_guest_hint'] = 'No account needed — click a lesson and enter your details to book.';
$lang['class_optional_account'] = 'Optional:';
$lang['class_guest_booking_hint'] = 'Book as a guest. Registration is optional and saves your details for next time.';
$lang['class_teacher'] = 'Teacher';
$lang['class_book'] = 'Book Class';
$lang['class_full'] = 'Full';
$lang['class_spots'] = 'spots';
$lang['class_no_classes'] = 'No classes scheduled for this day.';
$lang['class_no_classes_week'] = 'No lessons scheduled for this week.';
$lang['class_booking_modal_title'] = 'Book Class';
$lang['weekly_lessons'] = 'Weekly Lessons';
$lang['weekly_lesson'] = 'Weekly Lesson';
$lang['weekly_lessons_hint'] = 'Define fixed weekly lesson times shown on the public calendar. Each row is one recurring class slot.';
$lang['weekday'] = 'Weekday';
$lang['start_time'] = 'Start Time';
$lang['customer_register'] = 'Create Account';
$lang['customer_register_hint'] = 'Register to book lessons faster next time.';
$lang['customer_login'] = 'Member Login';
$lang['customer_login_hint'] = 'Sign in to book lessons with your saved details.';
$lang['customer_password_min_length'] = 'Password must be at least 8 characters.';
$lang['customer_email_taken'] = 'An account with this email already exists.';
$lang['already_have_account'] = 'Already have an account? Sign in';
$lang['create_account'] = 'Create a new account';
$lang['type_email_for_reset_link'] = 'Enter your email address and we will send you a password reset link.';
// End
