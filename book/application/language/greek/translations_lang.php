...
$lang['about_app'] = 'Σχετικά με το thesibook.gr';
...
$lang['about_app_info'] = 'Το thesibook.gr είναι μια εξαιρετικά προσαρμόσιμη διαδικτυακή εφαρμογή η οποία επιτρέπει στους πελάτες σας να κλείνουν ραντεβού με εσάς μέσω του διαδικτύου. Επιπλέον παρέχει την δυνατότητα να συγχρονίσετε τα δεδομένα σας με το Google Calendar έτσι ώστε να μπορέσετε να τα χρησιμοποιήσετε με άλλες υπηρεσίες.';
$lang['current_version'] = 'Τρέχουσα Έκδοση';
$lang['support'] = 'Υποστήριξη';
$lang['about_app_support'] = 'Αν αντιμετωπίσετε προβλήματα κατά την χρήση του thesibook.gr μπορείτε να ψάξετε το επίσημο Google Group για απαντήσεις. Μπορείτε επίσης να δημιουργήσετε ένα νέο θέμα στην σελίδα Google Code έτσι ώστε να βοηθήσετε την πρόοδο της ανάπτυξης.';
...
$lang['about_app_license'] = 'Το thesibook.gr έχει αδειοδοτηθεί υπό την άδεια χρήσης GPLv3. Χρησιμοποιώντας τον κώδικα του thesibook.gr με οποιονδήποτε τρόπο συμφωνείτε με τους όρους που περιγράφονται στον ακόλουθο σύνδεσμο:';
...
$lang['ea_update_success'] = 'Το thesibook.gr ενημερώθηκε με επιτυχία.';
...
$lang['api_token_hint'] = 'Καταχωρήστε εναν μυστικό κωδικό για να μπορέσετε να ενεργοποιήσετε την token-based πιστοποίηση του thesibook.gr API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Το API σας επιτρέπει να αλληλεπιδράτε με όλα τα δεδομένα του thesibook.gr μέσω του πρωτοκόλλου HTTP και των διαθέσιμων σημείων τερματισμού API και να δημιουργείτε τις δικές σας ενσωματώσεις.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Αυτή η ενσωμάτωση σας επιτρέπει να συνδεθείτε σε έναν υπάρχοντα διακομιστή LDAP και να εισάγετε αυτόματα τους χρήστες στο thesibook.gr και να τους επιτρέπετε να κάνουν SSO με τον κωδικό πρόσβασης του καταλόγου τους (το όνομα χρήστη πρέπει να ταιριάζει).';
...
$lang['class_oriented_booking'] = 'Λειτουργία κρατήσεων μαθημάτων';
$lang['class_oriented_booking_hint'] = 'Εμφανίζει εβδομαδιαίο ημερολόγιο μαθημάτων αντί για τον οδηγό υπηρεσίας/παρόχου. Κάθε μάθημα είναι Υπηρεσία με σταθερή ώρα και συνδεδεμένο εκπαιδευτή.';
$lang['class_schedule_title'] = 'Εβδομαδιαίο πρόγραμμα';
$lang['class_weekly_hint'] = 'Κάντε κλικ σε διαθέσιμο μάθημα για να κλείσετε θέση. Τα πλήρη εμφανίζονται γκρι.';
$lang['class_guest_hint'] = 'Δεν χρειάζεται λογαριασμός — κάντε κλικ σε μάθημα και συμπληρώστε τα στοιχεία σας.';
$lang['class_optional_account'] = 'Προαιρετικά:';
$lang['class_guest_booking_hint'] = 'Κράτηση ως επισκέπτης. Η εγγραφή είναι προαιρετική και αποθηκεύει τα στοιχεία σας για την επόμενη φορά.';
$lang['class_teacher'] = 'Εκπαιδευτής';
$lang['class_book'] = 'Κράτηση μαθήματος';
$lang['class_full'] = 'Πλήρες';
$lang['class_spots'] = 'θέσεις';
$lang['class_no_classes'] = 'Δεν υπάρχουν μαθήματα για αυτή την ημέρα.';
$lang['class_no_classes_week'] = 'Δεν υπάρχουν μαθήματα για αυτή την εβδομάδα.';
$lang['class_booking_modal_title'] = 'Κράτηση μαθήματος';
$lang['weekly_lessons'] = 'Εβδομαδιαία μαθήματα';
$lang['weekly_lesson'] = 'Εβδομαδιαίο μάθημα';
$lang['weekly_lessons_hint'] = 'Ορίστε σταθερές ώρες μαθημάτων που εμφανίζονται στο δημόσιο ημερολόγιο.';
$lang['weekday'] = 'Ημέρα';
$lang['start_time'] = 'Ώρα έναρξης';
$lang['customer_register'] = 'Δημιουργία λογαριασμού';
$lang['customer_register_hint'] = 'Εγγραφείτε για γρηγορότερες κρατήσεις μαθημάτων.';
$lang['customer_login'] = 'Σύνδεση μέλους';
$lang['customer_login_hint'] = 'Συνδεθείτε για κράτηση με τα αποθηκευμένα στοιχεία σας.';
$lang['customer_password_min_length'] = 'Ο κωδικός πρέπει να έχει τουλάχιστον 8 χαρακτήρες.';
$lang['customer_email_taken'] = 'Υπάρχει ήδη λογαριασμός με αυτό το email.';
$lang['already_have_account'] = 'Έχετε ήδη λογαριασμό; Συνδεθείτε';
$lang['create_account'] = 'Δημιουργία νέου λογαριασμού';
$lang['type_email_for_reset_link'] = 'Εισάγετε το email σας και θα σας στείλουμε σύνδεσμο επαναφοράς κωδικού.';
// End
