...
//   // Default task
// gulp.task('fonts:clean', gulp.series('copy-fonts'));
// gulp.task('fonts:dev', gulp.series('copy-fonts'));
// gulp.task('fonts:prod', gulp.series('copy-fonts'));
// gulp.task('fonts:watch', gulp.series('copy-fonts'));
